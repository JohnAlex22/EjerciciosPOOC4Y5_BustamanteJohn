package Ejercicio9_10;
 ...
 class Ejercicio9Producto {
	 private int identificador; // Atributo que representa el identificador de un producto 
	 private String nombre; // Atributo que identifica el nombre de un producto
	 private String descripción; // Atributo que identifica la descripción de un producto 
	 private int precio; // Atributo que identifica el precio de un producto 
	 
	 /**
	 * Constructor de la clase Producto
	 * @param identificador Parámetro que define el identificador de un  producto
	 * @param nombre Parámetro que define el nombre de un producto 
	 * @param descripción Parámetro que define la descripción de un  producto
	 * @param precio Parámetro que define el precio de un producto 
	 */
	 public Ejercicio9Producto(int identificador, String nombre, String descripción, 
	 int precio) {
	 ...
	 */
	 public String toString() {
		 return "id = " + identificador + ", Nombre = " + nombre + ", Descripción = " + descripción + ", Precio = $ " + precio;
		 } 
