...
public class Ejercicio3Círculo {
	
	// Atributo que identifica el punto central donde se encuentra localizado un círculo 
	Ejercicio3Punto centro;
	int radio; // Atributo que identifica el radio de un círculo
	
	/**
	* Constructor de la clase Círculo
	* @param x Parámetro que define la coordenada x de un punto que  establece el centro del círculo
	* @param y Parámetro que define la coordenada y de un punto que establece el centro del círculo
	* @param radio Parámetro que define el radio del círculo
	*/
	public Ejercicio3Círculo(int x, int y, int radio) {
		centro = new Ejercicio3Punto(x,y); // Crea un círculo con los valores pasados como parámetros
