...
public abstract class Ejercicio12Ciclista {
     ...
     */
    public Ejercicio12Ciclista(int identificador, String nombre) {
     ...
     * @param Parámetro que especifica el puesto que ocupa un ciclista en la posición general
     */
