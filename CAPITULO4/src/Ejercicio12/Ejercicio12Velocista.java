...
public class Ejercicio12Velocista extends Ejercicio12Ciclista {
     ...
     */
    public Ejercicio12Velocista(int identificador, String nombre, double potenciaPromedio, double velocidadPromedio) {
