...
public class Ejercicio12Escalador extends Ejercicio12Ciclista {
     ...
     */
    public Ejercicio12Escalador(int identificador, String nombre, double aceleraciónPromedio, double gradoRampa) {
