...
public class Ejercicio12Equipo {
	...
	*/
	public Ejercicio12Equipo(String nombre, String país) {
	this.nombre = nombre;
	this.país =  país;
	...
	*/
	void añadirCiclista(Ejercicio12Ciclista ciclista) {
	...
	*/
	void listarEquipo() {
		...
		for (int i = 0; i < listaCiclistas.size(); i++) {
			Ejercicio12Ciclista c = (Ejercicio12Ciclista) listaCiclistas.elementAt(i); // Se aplica casting para extraer el elemento
		...
		*/
		...
		for (int i = 0; i < listaCiclistas.size(); i++) { // Se recorre el vector de ciclistas 
			Ejercicio12Ciclista c = (Ejercicio12Ciclista) listaCiclistas.elementAt(i); // Se obtiene un elemento del vector
