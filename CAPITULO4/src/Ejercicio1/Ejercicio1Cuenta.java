...
public class Ejercicio1Cuenta {
	...
	* la cuenta
	*/
	public Ejercicio1Cuenta(float saldo, float tasaAnual) {
	this.saldo = saldo;
	...
	* */
    ...
    calcularInterés();
    númeroRetiros = 0; // Reinicia el número de retiros después de generar el extracto mensual
    }
}
