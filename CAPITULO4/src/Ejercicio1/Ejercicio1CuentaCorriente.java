...
public class Ejercicio1CuentaCorriente extends Ejercicio1Cuenta {
	...
	* cuenta corriente
	*/
	public Ejercicio1CuentaCorriente(float saldo, float tasa) {
	...
	public void consignar(float cantidad) {
		...
		*/
		public void imprimir() {
		    System.out.println("Saldo: " + saldo + " Comisión mensual: " + comisiónMensual +
