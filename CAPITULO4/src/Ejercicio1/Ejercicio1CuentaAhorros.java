...
public class Ejercicio1CuentaAhorros extends Ejercicio1Cuenta {
	...
	* cuenta de ahorros
	*/
	public Ejercicio1CuentaAhorros(float saldo, float tasa) {
	super(saldo, tasa);
	...
	*/
	...
	System.out.println("Saldo: "  + saldo + "Comisión mensual: " +  
	comisiónMensual + "Número de transacciones: "  + (númeroConsignaciones + númeroRetiros));
	System.out.println();
	}
