...
public class Ejercicio3CasaRural extends Ejercicio3Casa {
    ...
    */
    public Ejercicio3CasaRural(int identificadorInmobiliario, int área, String 
    dirección, int númeroHabitaciones, int númeroBaños, int 
    númeroPisos, int distanciaCabecera, int altitud) {
