...
public class Ejercicio3ApartamentoFamiliar extends Ejercicio3Apartamento {
    ...
    */
    public Ejercicio3ApartamentoFamiliar(int identificadorInmobiliario, int área, String dirección, int númeroHabitaciones, 
