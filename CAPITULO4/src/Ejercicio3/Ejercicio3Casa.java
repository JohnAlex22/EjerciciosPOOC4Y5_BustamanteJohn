...
public class Ejercicio3Casa extends Ejercicio3InmuebleVivienda {
    protected int númeroPisos; /* Atributo que identifica el número de pisos que tiene una casa */
    ...
    * que tiene una casa
    */
    public Ejercicio3Casa(int identificadorInmobiliario, int área, String dirección, int númeroHabitaciones, int númeroBaños, int númeroPisos) { 
